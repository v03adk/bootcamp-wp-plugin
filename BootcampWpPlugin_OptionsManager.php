...
class BootcampWpPlugin_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'bootcamp-wp-plugin'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'bootcamp-wp-plugin'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'bootcamp-wp-plugin'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'bootcamp-wp-plugin'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'bootcamp-wp-plugin');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'bootcamp-wp-plugin'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'bootcamp-wp-plugin');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'bootcamp-wp-plugin'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'bootcamp-wp-plugin') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'bootcamp-wp-plugin');
            case 'false':
                return __('false', 'bootcamp-wp-plugin');

            case 'Administrator':
                return __('Administrator', 'bootcamp-wp-plugin');
            case 'Editor':
                return __('Editor', 'bootcamp-wp-plugin');
            case 'Author':
                return __('Author', 'bootcamp-wp-plugin');
            case 'Contributor':
                return __('Contributor', 'bootcamp-wp-plugin');
            case 'Subscriber':
                return __('Subscriber', 'bootcamp-wp-plugin');
            case 'Anyone':
                return __('Anyone', 'bootcamp-wp-plugin');
        }
        return $optionValue;
    }
